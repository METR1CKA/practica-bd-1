...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.socios (`id`, `nombre`, `apellidos`, `direccion`, `telefono`, `correo`)
VALUES (NULL, 'Juan', 'Perez', 'Calle 123, Ciudad', '1234567890', 'Juanperezthegamer@gmail.com'),
...
VALUES (NULL, 'Guillermo', 'Valentino Sánchez'),
...
VALUES (NULL, 'Drama', 'este es un genero muy aclamado por la audencia'),
...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.peliculas (`id`, `titulo`, `fecha_lanzamiento`, `genero_id`, `existencia`, `director_id`)
VALUES (NULL, 'Dungeons and dragons', '2022-01-01', 1, 50, 1),
...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.directores_favoritos (`id`, `socio_id`, `director_id`)
VALUES (NULL, 1, 7),
    (NULL, 2, 2),
    (NULL, 3, 3),
    (NULL, 4, 4),
...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.directores_peliculas (`id`, `director_id`, `pelicula_id`)
VALUES (NULL, 1, 1),
    (NULL, 2, 2),
    (NULL, 3, 3),
    (NULL, 4, 4),
...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.actores_peliculas (`id`, `actor_id`, `pelicula_id`)
VALUES (NULL, 1, 1),
    (NULL, 2, 2),
    (NULL, 3, 3),
    (NULL, 4, 4),
...
-- -----------------------------------------------------
INSERT INTO
    blockbuster.prestamos_finalizados (`id`, `fecha_entrega`, `prestamo_id`)
VALUES (NULL, '2024-01-23 12:30:00', 1),
